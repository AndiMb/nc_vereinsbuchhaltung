...
- **Wächter-Ordner für Belege.** Neben der app-internen Ablage und dem von
  ...
  sind – Umbenennen und Verschieben in der Dateien-App bricht die
  Verknüpfung nicht, die App merkt sich die Nextcloud-Datei-ID. Aus der App
...
- **Die Übersicht meldet Dokumente ohne Buchung.** Liegt im Wächter-Ordner
  ...
  Dateien-App gelöscht oder verschoben wurde; der Prüf-ZIP listet solche
  Belege weiterhin in `fehlende_dateien.txt` auf.
...
- **Beim Einschalten** bekommen Belege, die die App bisher unter
  ...
  bisherige Belegordner kann so direkt zum Wächter-Ordner werden.
